    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      function showDashboard(userData) {
        ...
        if (userData) {
          ...
          // Update stats based on user data or use defaults
          document.getElementById("stat-projects").textContent = userData.projects || "12";
          document.getElementById("stat-tasks").textContent = userData.tasks || "48";
          document.getElementById("stat-team").textContent = userData.team || "5";
        }
