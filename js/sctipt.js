  <script>
    document.addEventListener("DOMContentLoaded", function () {
      ...
      function showLoginSuccess() {
        ...
        successText.textContent = `You have successfully logged in as ${email}`;
        loginForm.classList.remove("active");
      ...
      function validateSignup() {
        ...
        if (!password || !validatePassword(password)) {
          showError("signup-password-error", "Password must be 8+ characters with at least one number");
          isValid = false;
        }
      ...
      function setupRealTimeValidation(inputId, validationFn, errorId, errorMessage) {
      ...
      setupRealTimeValidation("login-email", validateEmail, "login-email-error", "Please enter a valid email address");
      setupRealTimeValidation("signup-email", validateEmail, "signup-email-error", "Please enter a valid email address");
      setupRealTimeValidation("signup-name", validateName, "signup-name-error", "Name must be at least 2 characters");
      setupRealTimeValidation("signup-password", validatePassword, "signup-password-error", "8+ characters with at least one number");
