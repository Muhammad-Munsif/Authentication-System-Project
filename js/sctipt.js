    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      function validateSignup() {
        ...
        if (!firstName || !validateName(firstName)) {
          showError("signup-first-name-error", "First name is required");
          isValid = false;
        }

        if (!lastName || !validateName(lastName)) {
          showError("signup-last-name-error", "Last name is required");
          isValid = false;
        }
      ...
      function initDemoValues() {
        ...
        document.getElementById("signup-first-name").value = "John";
        document.getElementById("signup-last-name").value = "Doe";
        document.getElementById("signup-email").value = "john.doe@example.com";
        document.getElementById("signup-phone").value = "(555) 123-4567";
        
        // Set date of birth to 25 years ago
        const dob = new Date();
        dob.setFullYear(dob.getFullYear() - 25);
        document.getElementById("signup-dob").valueAsDate = dob;
        
        document.getElementById("signup-password").value = "SecurePass123";
        document.getElementById("signup-confirm-password").value = "SecurePass123";
